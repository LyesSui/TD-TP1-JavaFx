package com.example.td1.pacman;
...
public class Fantome extends Personnage {
    ...
    public void deplacerAGauche() {
        ...
        //sens de la bouche
        oeilGauche.setCenterX(oeilGauche.getCenterX() - LARGEUR_MOITIE_PERSONNAGE + .5);
        oeilGauche.setCenterY(oeilGauche.getCenterY());
        oeilDroit.setCenterX(oeilDroit.getCenterX() - LARGEUR_MOITIE_PERSONNAGE + .5);
    ...
    public void deplacerADroite(double largeurJeu) {
        ...
        //sens de la bouche
        //)  // uche.getCenterX() + LARGEUR_MOITIE_PERSONNAGE - .5);
        oeilGauche.setCenterY(oeilGauche.getCenterY());
        oeilDroit.setCenterX(oeilDroit.getCenterX() + LARGEUR_MOITIE_PERSONNAGE - .5);
        oeilDroit.setCenterY(oeilDroit.getCenterY());
    }
    ...
    public void deplacerEnBas(double hauteurJeu) {
        ...
        oeilGauche.setCenterY(oeilGauche.getCenterY() + LARGEUR_MOITIE_PERSONNAGE - .5);
        oeilGauche.setCenterX(oeilGauche.getCenterX());
        oeilDroit.setCenterY(oeilGauche.getCenterY() + LARGEUR_MOITIE_PERSONNAGE - .5);
        oeilDroit.setCenterX(oeilGauche.getCenterX());
    }
